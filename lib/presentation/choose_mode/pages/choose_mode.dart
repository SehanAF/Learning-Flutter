                    ...
                    children: [
                      Column(
                        children: [
                          ...
                          SizedBox(height: 15,),
                          Text("Dark Mode", style: TextStyle(color:AppColors.grey, fontWeight: FontWeight.w500, fontSize: 16),)
                        ],
                      ),
                      SizedBox(width: 40,),
                      Column(
                        children: [
                          ...
                          SizedBox(height: 15,),
                          Text("Light Mode", style: TextStyle(color:AppColors.grey, fontWeight: FontWeight.w500, fontSize: 16),)
                        ],
                      ),
                    ],
                  ),

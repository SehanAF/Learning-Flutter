...
import 'package:myapp/presentation/home/widget/news_songs.dart';
      ...
      decoration: BoxDecoration(
        border: Border(
          bottom: BorderSide(
              ...
              width: 0), // Menghilangkan garis bawah default
        ),
      ),
      child: TabBar(
        ...
        indicator: UnderlineTabIndicator(
          // Hanya menampilkan garis pada tab yang dipilih
          borderSide: BorderSide(color: AppColors.primary, width: 4.0),
          insets: EdgeInsets.symmetric(
              horizontal: 50.0), // Menyesuaikan panjang garis dengan teks
        ),
        indicatorSize: TabBarIndicatorSize
            .label, // Ukuran indikator mengikuti panjang label
